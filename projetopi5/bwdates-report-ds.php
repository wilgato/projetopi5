...
<form method="post" action="bwdates-report-result.php">
  ...
  <div class="form-group">
    ...
    <select class="form-control" id="paciente" name="paciente" required="true">      
...
?>
<option value="<?php echo $row['registro']."-".$row['name'];?>"><?php echo utf8_encode($row['name']);?></option>
<?php } ?>
</select>
</div>
...
<div class="form-group">
                                 <input type="submit" class="btn btn-primary btn-user btn-block" name="submit" value="Buscar">                           
                             </div>
