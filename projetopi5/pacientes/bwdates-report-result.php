...
?>
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Resultado do relatório de datas de <?php echo $fdate;?> para <?php echo $tdate;?> of <?php echo $familname;?></h1>
    

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Resultados do relatório de datas</h6>
                        </div>
                        <div class="card-body">
...
<h5 style="color:blue">Medicao</h5>
