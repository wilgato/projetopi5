        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">MR Monitoramento Remoto</h1>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary"><?php echo utf8_encode("Usário Login"); ?></h6>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="password-recovery.php">Esqueceu sua senha</a>
                                        </div>
